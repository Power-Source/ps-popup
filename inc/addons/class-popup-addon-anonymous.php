...
Addon Name:  Anonyme Lademethode

Plugin URI:  https://n3rds.work/piestingtal-source-project/ps-popup/

Description: Noch eine Lademethode.
...
class IncPopupAddon_AnonyousLoading {
	...
	static public function settings( $loading_methods ) {
		...
		$loading_methods[] = (object) array(
			...
			'label' => __( 'Anonymes Skript', 'popover' ) . $pro_only,

			'info'  => __(

				'Erhöhe drastisch die Chance, Werbeblocker zu umgehen. ' .

				'Lädt PopUp wie WordPress AJAX, aber die URL zum ' .

				'JavaScript-Datei ist maskiert. ', 'popover'
