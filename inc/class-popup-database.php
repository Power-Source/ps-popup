			...
			lib3()->ui->admin_message(
				...
				sprintf(
					...
					__(
						...
						'Deine Installation wurde erfolgreich aktualisiert, um die ' .

						'neueste Version des Plugins zu verwenden!<br />' .

						'<em>Hinweis: Einige PopUp-Optionen wurden geändert oder ersetzt. ' .

						'Du solltest Deine %sPopUps%s ansehen, ' .

						'um festzustellen, ob sie noch wie beabsichtigt aussehen.</em>', 'popover'
	...
	static public function get_loading_methods() {
		...
		if ( null === $Loading_methods ) {
			...
			$Loading_methods[] = (object) array(
				...
				'label' => __( 'Seiten Footer', 'popover' ),

				'info'  => __(

					'Füge PopUp als Teil des HTML-Codes Deiner Seite hinzu (kein AJAX-Aufruf).',
			...
			$Loading_methods[] = (object) array(
				...
				'info'  => __(
					...
					'Laden Sie PopUp separat von der Seite über einen WordPress AJAX-Aufruf. ' .

					'Dies ist die beste Option, wenn Du Caching verwendest.',
			...
			$Loading_methods[] = (object) array(
				...
				'label' => __( 'Benutzerdefiniertes AJAX', 'popover' ),

				'info'  => __(

					'Lade PopUp separat von der Seite über einen benutzerdefinierten Front-End-AJAX-Aufruf.',
