...
if ( defined( 'PO_REMOTE_IP_URL' ) && strlen( PO_REMOTE_IP_URL ) > 5 ) {
	...
	$geo_msg .= '<p class="locked-msg">' .
		...
		__(
			...
			'<strong>Benutzerdefinierter Webservice</strong>: Du hast einen benutzerdefinierten ' .

			'Suchdienst in <tt>wp-config.php</tt> über die Konstante ' .

			'"<tt>PO_REMOTE_IP_URL</tt>" konfiguriert. Um einen der Standarddienste zu verwenden' .

			'musst Du diese Konstante aus wp-config.php entfernen.',
...
<div class="wrap nosubsub">
	...
	<h2><?php _e( 'PopUp Einstellungen', 'popover' ); ?></h2>
	...
	<form method="post" action="<?php echo esc_url( $form_url ); ?>">
		...
		<div class="wpmui-box static">
			...
			<h3>
				...
				<span><?php _e( 'PopUp Lademethode', 'popover' ); ?></span>
			...
			<div class="inside">
				...
				_e(
					...
					'Wähle aus, wie Du PopUp laden möchtest.', 'popover'
				...
				<tbody>
					...
					<tr>
						...
						<th><?php _e( 'Ländersuche', 'popover' ); ?></th>
						...
						<td>
							...
							<select
								...
								<optgroup label="<?php _e( 'Benutzerdefinierter Webservice', 'popover' ); ?>">
								...
								<optgroup label="<?php _e( 'Webservice', 'popover' ); ?>">
								...
								<optgroup label="<?php _e( 'Lokale Datenbank', 'popover' ); ?>">
									...
									<option value="geo_db"
										...
										<?php _e( 'Lokale IP-Nachschlagetabelle', 'popover' ); ?>
							...
							<button type="button" class="button test-location">
								...
								<?php _e( 'Teste meinen Standort', 'popover' ); ?>
							...
							_e(
								...
								'Diese Option ist relevant für die ' .

								'Bedingung "Besucherlocation".',
		...
		<div class="wpmui-box <?php echo esc_attr( $theme_compat->okay ? 'closed' : '' ); ?>">
			...
			<h3>
				...
				<a href="#" class="toggle" title="<?php _e( 'Klicke zum Umschalten' ); ?>"><br></a>

				<span><?php _e( 'Theme-Kompatibilität', 'popover' ); ?></span>
			...
			<div class="inside">
				...
				_e(
					...
					'Hier kannst Du sehen, ob Dein Theme mit der Lademethode' .

					'"Footer"  kompatibel ist.', 'popover'
		...
		<div class="wpmui-box closed">
			...
			<h3>
				...
				<span><?php _e( 'Unterstützte Shortcodes', 'popover' ); ?></span>
		...
		<p class="submit">
			...
			<button class="button-primary">
				...
				<?php _e( 'Alle Änderungen speichern', 'popover' ) ?>
		...
		<h2><?php _e( 'Verfügbare Bedingungen', 'popover' ); ?></h2>
			...
			<?php foreach ( array( 'thead', 'tfoot' ) as $tag ) : ?>
				...
				<tr>
					...
					<th class="manage-column column-items" scope="col">
						...
						<?php _e( 'Aktivierte Regeln', 'popover' ); ?>
